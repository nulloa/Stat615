...
\section*{Problem 7.}
I think based on the different diagnostics and trace plots, I like MCMC 1 better. The diagnostics look better and the implementation for MCMC 1 is much simpler. MCMC 1 is a lot quicker at getting good samples and it's Geweke diagnostics look like they come from a std normal.
